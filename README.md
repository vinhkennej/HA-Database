...
B1: Cài đặt  Percona XtraDB Cluster
...
-----------------------------------------------------------------
Replication(đồng bộ dữ liệu) của PostgreSQL
